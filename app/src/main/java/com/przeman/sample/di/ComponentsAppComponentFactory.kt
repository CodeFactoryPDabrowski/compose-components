...
import com.przeman.sample.ComponentsApp
import javax.inject.Provider

@Keep
class ComponentsAppComponentFactory : AppComponentFactory() {
    ...
    override fun instantiateActivityCompat(
        ...
        return getInstance(cl, className, activityProviders) ?: super.instantiateActivityCompat(
            cl, className, intent
        )
    }
    ...
    override fun instantiateApplicationCompat(cl: ClassLoader, className: String): Application {
        ...
        activityProviders = (app as ComponentsApp).appComponent().activityProviders
        return app
    }
