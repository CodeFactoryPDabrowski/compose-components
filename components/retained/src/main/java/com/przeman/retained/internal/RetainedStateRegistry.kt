...
interface RetainedStateRegistry {
     ...
     */
    fun registerValue(key: String, valueProvider: () -> Any?): Entry
...
internal object NoOpRetainedStateRegistry : RetainedStateRegistry {
    ...
    override fun registerValue(key: String, valueProvider: () -> Any?): RetainedStateRegistry.Entry = NoOpEntry
    override fun performSave() {}
    override fun forgetUnclaimedValues() {}
